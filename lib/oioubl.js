...
<Invoice xmlns="urn:oasis:names:specification:ubl:schema:xsd:Invoice-2"
  ...
  <cbc:IssueDate>${esc(invoice.fakturadato)}</cbc:IssueDate>
  <cbc:InvoiceTypeCode listAgencyID="320" listID="urn:oioubl:codelist:invoicetypecode-1.1">${typeCode}</cbc:InvoiceTypeCode>
  <cbc:Note>Periode: ${esc(invoice.periode_fra)} – ${esc(invoice.periode_til)}</cbc:Note>
  ...
  <cac:PaymentMeans>
    ...
    <cbc:PaymentDueDate>${esc(invoice.forfaldsdato)}</cbc:PaymentDueDate>
  </cac:PaymentMeans>
  <cac:TaxTotal>
